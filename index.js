...
const l = console.log
var { updateCMDStore, isbtnID, getCMDStore, getCmdForCmdId, input, get } = require("./lib/database")

//===================SESSION============================
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
  if (config.SESSION_ID) {
    const sessdata = config.SESSION_ID.replace("HIRAN-MD=", "")
...
╰━━━━━━━━━━━━━━━━━━━╯`;
        ...
        console.log('HIRAN-MD connected ✅')
    ...
    try {
        ...
        return await conn.sendMessage(from, {
          ...
          contextInfo: {
            ...
            externalAdReply: {
              ...
              mediaType: 1,
              sourceUrl: "https://wa.me/message/C3WDNO2UCH7RC1",
      ...
      conn.buttonMessage2 = async (jid, msgData, quotemek) => {
        if (!NON_BUTTON) {
          ...
          if (msgData.headerType === 1) {
            ...
            const textmsg = await conn.sendMessage(from, {
              text: buttonMessage,
              contextInfo: {
                mentionedJid: [''],
                groupMentions: [],
            ...
            const imgmsg = await conn.sendMessage(jid, {
              image: msgData.image,
      ...
      conn.listMessage2 = async (jid, msgData, quotemek) => {
        if (!NON_BUTTON) {
          ...
          const text = await conn.sendMessage(from, {
            text: listMessage,
            contextInfo: {
              mentionedJid: [''],
              groupMentions: [],
